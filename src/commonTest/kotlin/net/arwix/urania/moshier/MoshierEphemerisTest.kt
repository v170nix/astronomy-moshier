...
class MoshierEphemerisTest {
    ...
    fun sunTest() = runTest {
        ...
        assertEquals("3h 10m 13.88s", j2000Body.phi.toRightAscension().toString())
        assertEquals("17deg 44m 22.0s", j2000Body.theta.toDeclination().toString())
        ...
        assertEquals("3h 11m 27.28s", apparentBody.phi.toRightAscension().toString())
        assertEquals("17deg 49m 18.3s", apparentBody.theta.toDeclination().toString())
    ...
    fun lunarTest() = runTest {
        ...
        assertEquals("18h 28m 41.91s", lunarJ2000Body.phi.toRightAscension().toString())
        assertEquals("-18deg 14m 51.4s", lunarJ2000Body.theta.toDeclination().toString())
        ...
        assertEquals("18h 24m 10.91s", lunarApparentBody.phi.toRightAscension().toString())
        assertEquals("-18deg 17m 40.2s", lunarApparentBody.theta.toDeclination().toString())
    ...
    fun mercuryTest() = runTest {
        ...
        assertEquals("4h 9m 1.14s", j2000Body.phi.toRightAscension().toString())
        assertEquals("22deg 39m 9.4s", j2000Body.theta.toDeclination().toString())
        ...
        assertEquals("4h 10m 18.45s", apparentBody.phi.toRightAscension().toString())
        assertEquals("22deg 42m 35.7s", apparentBody.theta.toDeclination().toString())
    ...
    fun venusTest() = runTest {
        ...
        assertEquals("0h 36m 36.86s", j2000Body.phi.toRightAscension().toString())
        assertEquals("2deg 5m 31.2s", j2000Body.theta.toDeclination().toString())
        ...
        assertEquals("0h 37m 43.92s", apparentBody.phi.toRightAscension().toString())
        assertEquals("2deg 12m 42.8s", apparentBody.theta.toDeclination().toString())
    ...
    fun marsTest() = runTest {
        ...
        assertEquals("17h 14m 44.87s", marsJ2000Body.phi.toRightAscension().toString())
        assertEquals("-26deg 1m 43.2s", marsJ2000Body.theta.toDeclination().toString())
        ...
        assertEquals("17h 9m 58.67s", marsApparentTransformBody.phi.toRightAscension().toString())
        assertEquals("-25deg 56m 14.6s", marsApparentTransformBody.theta.toDeclination().toString())
        ...
        assertEquals("17h 9m 58.67s", marsApparentBody.phi.toRightAscension().toString())
        assertEquals("-25deg 56m 14.6s", marsApparentBody.theta.toDeclination().toString())
        ...
        assertEquals("17h 14m 44.87s", marsJ2000TransformBody.phi.toRightAscension().toString())
        assertEquals("-26deg 1m 43.2s", marsJ2000TransformBody.theta.toDeclination().toString())
    ...
    fun jupiterTest() = runTest {
        ...
        assertEquals("0h 0m 38.88s", j2000Body.phi.toRightAscension().toString())
        assertEquals("-1deg 7m 35.1s", j2000Body.theta.toDeclination().toString())
        ...
        assertEquals("0h 1m 45.92s", apparentBody.phi.toRightAscension().toString())
        assertEquals("-1deg 0m 17.8s", apparentBody.theta.toDeclination().toString())
    ...
    fun saturnTest() = runTest {
        ...
        assertEquals("21h 48m 23.94s", j2000Body.phi.toRightAscension().toString())
        assertEquals("-14deg 21m 51.0s", j2000Body.theta.toDeclination().toString())
        ...
        assertEquals("21h 49m 35.81s", apparentBody.phi.toRightAscension().toString())
        assertEquals("-14deg 15m 42.3s", apparentBody.theta.toDeclination().toString())
    ...
    fun uranusTest() = runTest {
        ...
        assertEquals("2h 49m 52.38s", j2000Body.phi.toRightAscension().toString())
        assertEquals("15deg 56m 17.1s", j2000Body.theta.toDeclination().toString())
        ...
        assertEquals("2h 51m 4.53s", apparentBody.phi.toRightAscension().toString())
        assertEquals("16deg 1m 40.4s", apparentBody.theta.toDeclination().toString())
    ...
    fun neptuneTest() = runTest {
        ...
        assertEquals("23h 41m 41.92s", j2000Body.phi.toRightAscension().toString())
        assertEquals("-3deg 13m 35.4s", j2000Body.theta.toDeclination().toString())
        ...
        assertEquals("23h 42m 49.19s", apparentBody.phi.toRightAscension().toString())
        assertEquals("-3deg 6m 19.2s", apparentBody.theta.toDeclination().toString())
    ...
    fun plutoTest() = runTest {
        ...
        assertEquals("20h 3m 11.26s", j2000Body.phi.toRightAscension().toString())
        assertEquals("-22deg 27m 23.6s", j2000Body.theta.toDeclination().toString())
        ...
        assertEquals("20h 4m 30.13s", apparentBody.phi.toRightAscension().toString())
        assertEquals("-22deg 23m 38.7s", apparentBody.theta.toDeclination().toString())
